...
<aside class="mt-5  rounded mb-4 pt-1" style="margin-left: 25%; width:50%; background: rgba(0, 0, 0, 0.6)">
            ...
            <div class="col text-center">
             ...
             <div class="text-center text-warning">
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="pb-2">
                    ...
                    <input type="text" name="nom" id="nom" size="50" placeholder="Votre nom">
                    </div>
                    <div class="form-group">
                        <label for="email" class="text-warning">votre email : </label><br>
                            <input type="email" name="email" id="email" size="50" placeholder="Votre email">
                    </div>
                    <div class="form-group">
