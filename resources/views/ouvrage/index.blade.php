    ...
    <div class="row">
      ...
      <div class="col-lg-3 mt-5 pt-4">
        ...
        @foreach($genre as $genre)
          <a href="{{ route('ouvrage', ['genre' => $genre->slug]) }}" class="list-group-item">{{ $genre->name }}</a>
          @endforeach
      ...
      <div class="container">
        ...
        <div class="col-lg-6">
        <form action="{{ route('ouvrage.search') }}" method="get" class="d-flex my-2">
        ...
        <!--   $ouvrage->appends(request()->input())->links() /.row -->
